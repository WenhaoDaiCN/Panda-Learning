...
- 回答有关项目的问题，例如Stack Overflow（[如Postgres示例](https://stackoverflow.com/questions/18664074/getting-error-peer-authentication-failed-for-user-postgres-when-trying-to-ge)）或Reddit
- 回答有关未解决问题的人的问题
- 帮助调节讨论板或对话渠道
